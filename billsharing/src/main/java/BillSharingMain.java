...
public class BillSharingMain {
    ...
    public static void main(String[] args) throws ContributionExceededException, InvalidExpenseException,
        ...
        try {
            ...
            System.out.println(expenseDoesNotExistsException);
        }
    ...
    private static void contributeToExpense(String expenseId, String userId)
            throws ContributionExceededException, ExpenseSettledException, InvalidExpenseException {
